        ...
        .then(
            function (json) {
                ...
                for(var cont = 0; cont < json.length; cont++) {
                    var linea = "<div class='comida'><img class='fotos' src='../Media/avena.jpg'><h1 class='estilo-nombres'>" + json[cont].titulo + "</h1></div><div class='texto'><p class='estilo-texto'><i class='fa-solid fa-bowl-food'></i> TIPO DE RECETA: " + json[cont].tipo +"<br> <i class='fa-solid fa-carrot'></i> INGREDIENTES: <br><br>" + json[cont].ingredientes + "<br><br>PROCEDIMIENTO: <br><br>" + json[cont].instrucciones + "</p></div>"
